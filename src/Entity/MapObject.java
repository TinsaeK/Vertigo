...
public abstract class MapObject {
    ...
    public void draw(Graphics2D graphics2D){
        if (faceRight){
            graphics2D.drawImage(anim.getImage(),(int)(one+xmap-w/2),(int)(two+ymap-h/2),null);
        }
        else {
            graphics2D.drawImage(anim.getImage(),(int)(one+xmap-w/2+w),(int)(two+ymap-h/2),-w,h,null);
        }
    }
